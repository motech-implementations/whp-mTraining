...
public class CourseStructureValidatorTest {
    ...
    public void shouldReturnErrorIfCSVHasMoreThanOneCourse() {
        courseStructureCsvs.add(new CourseCsvRequest("Basic Malaria Symptoms", "Course", "Active", null, "Message Description", "filename"));
        errors = courseStructureValidator.validate(courseStructureCsvs);
        assertThat(errors.size(), is(1));
    ...
    public void shouldReturnErrorWhenParentNodeIsAbsent() {
        courseStructureCsvs.add(new CourseCsvRequest("Message TB Symptoms New", "Message", "Active", null, "Message Description", "filename"));
        errors = courseStructureValidator.validate(courseStructureCsvs);
    ...
    public void shouldAddErrorWhenNonMessageNodeDoesNotHaveChild() throws Exception {
        courseStructureCsvs.add(new CourseCsvRequest("Module TB Symptoms2", "Module", "Active", "Basic TB Symptoms", "Message Description", "filename"));
        courseStructureCsvs.add(new CourseCsvRequest("Chapter TB Symptoms2", "Chapter", "Active", "Module TB Symptoms2", "Message Description", "filename"));
        errors = courseStructureValidator.validate(courseStructureCsvs);
        assertEquals(1, errors.size());
    ...
    public void shouldReturnErrorForChildStateIfParentIsInvalid() throws Exception {
        courseStructureCsvs.add(new CourseCsvRequest("Module TB Symptoms2", "Module", "Active", "Basic TB Symptoms1-parent", "Message Description", "Filename"));
        courseStructureCsvs.add(new CourseCsvRequest("Chapter TB Symptoms Version 2", "Chapter", "Active", "Module TB Symptoms2", "description Module TB Symptoms2", "Filename"));
    ...
    public void shouldReturnErrorIfNoOfQuestionsIsLessThanTheRequiredNoOfQuestionsToBeAnswered() {
        courseStructureCsvs.add(new CourseCsvRequest("Chapter TB Symptoms1", "Chapter", "inactive", "Module TB Symptoms", "Message Description", "Filename", null, null, null, "2", "60"));
    ...
    public void shouldReturnErrorIfNoOfQuestionsIsGreaterThanZeroAndPassPercentageIsNotValid() {
        courseStructureCsvs.add(new CourseCsvRequest("Chapter TB Symptoms1", "Chapter", "Active", "Module TB Symptoms", "Message Description", "Filename", null, null, null, "2", "200"));
        courseStructureCsvs.add(new CourseCsvRequest("Question TB Symptoms1", "Question", "Active", "Chapter TB Symptoms1", "Message Description", "FileName", "1;2", "1", "CorrectAnswer", null, null));
    ...
    public void shouldThrowNumberFormatExceptionWhenNoOfQuestionsIsNonNumeric() {
        courseStructureCsvs.add(new CourseCsvRequest("Chapter TB Symptoms1", "Chapter", "Active", "Module TB Symptoms", "Message Description", "Filename", null, null, null, "*", ""));
        courseStructureCsvs.add(new CourseCsvRequest("Question TB Symptoms1", "Question", "Active", "Chapter TB Symptoms1", "Message Description", "FileName", "1;2", "1", "CorrectAnswer", null, null));
    ...
    public void shouldReturnErrorIfActiveCourseHasNoActiveChild() {
        List<CourseCsvRequest> courseStructureCsvs = new ArrayList<>();
        courseStructureCsvs.add(new CourseCsvRequest("Basic TB Symptoms", "Course", "Active", null, "Message Description", "Filename"));
        courseStructureCsvs.add(new CourseCsvRequest("Module TB Symptoms", "Module", "inactive", "Basic TB Symptoms", "Message Description", "Filename"));
        courseStructureCsvs.add(new CourseCsvRequest("Module TB Symptoms2", "Module", "inactive", "Basic TB Symptoms", "Message Description", "Filename"));
    ...
    public void shouldNotReturnErrorIfInActiveCourseHasHasNoActiveChild() {
        List<CourseCsvRequest> courseStructureCsvs = new ArrayList<>();
        courseStructureCsvs.add(new CourseCsvRequest("Basic TB Symptoms", "Course", "inActive", null, "Message Description", "Filename"));
        courseStructureCsvs.add(new CourseCsvRequest("Module TB Symptoms", "Module", "inactive", "Basic TB Symptoms", "Message Description", "Filename"));
        courseStructureCsvs.add(new CourseCsvRequest("Module TB Symptoms2", "Module", "inactive", "Basic TB Symptoms", "Message Description", "Filename"));
        courseStructureCsvs.add(new CourseCsvRequest("Chapter TB Symptoms", "Chapter", "Active", "Module TB Symptoms", "Message Description", "fileName", null, null, null, "1", "1"));
        courseStructureCsvs.add(new CourseCsvRequest("Chapter TB Symptoms2", "Chapter", "Active", "Module TB Symptoms2", "Message Description", "fileName", null, null, null, "0", "0"));
