...
public class ChapterUpdaterTest {
    ...
    public void shouldUpdateContentId() {
        ChapterDto chapterDtoToBeUpdated = new ChapterDto(true, "chapter1", "some description", FILENAME, "Created By", Collections.EMPTY_LIST, null);
        UUID chapterContentId = UUID.randomUUID();
        ChapterDto chapterDtoFromDb = new ChapterDto(chapterContentId, 1, true, "chapter1", "some description", FILENAME, "Created By", Collections.EMPTY_LIST, null);
    ...
    public void shouldUpdateChildContents() throws Exception {
        ...
        ChapterDto chapterDto = new ChapterDto(true, "chapter1", "some description", FILENAME, "Created By", messages, null);
    ...
    public void shouldGetExistingChaptersFromDbOnlyFirstTime() throws Exception {
        ChapterDto chapterDtoFromDb = new ChapterDto(true, "chapter1", "some description", FILENAME, "Created By", Collections.EMPTY_LIST, null);
    ...
    public void shouldEquateChaptersByName() throws Exception {
        ChapterDto chapter1 = new ChapterDto(true, "chapter1", "old description", FILENAME, "Created By", Collections.EMPTY_LIST, null);
        ChapterDto chapter2 = new ChapterDto(UUID.randomUUID(), 1, true, "chapter1", "new description", FILENAME, "Created By", Collections.EMPTY_LIST, null);
        assertTrue(chapterUpdater.isEqual(chapter1, chapter2));

        ChapterDto chapter3 = new ChapterDto(true, "chapter2", "old description", FILENAME, "Created By", Collections.EMPTY_LIST, null);
        assertFalse(chapterUpdater.isEqual(chapter1, chapter3));
    }

    @Test
    public void shouldInvalidateExistingContentCache() {
        final ChapterDto chapterDtoFromDb = new ChapterDto(true, "chapter1", "some description", FILENAME, "Created By", Collections.EMPTY_LIST, null);
